...
import com.meta.wearable.dat.externalsampleapps.cameraaccess.retrofit.FileViewModel    // Importar mi viewModel
...
class MainActivity : ComponentActivity() {
  ...
  val videoViewModel: FileViewModel by viewModels()    // Inicializar viewModel
